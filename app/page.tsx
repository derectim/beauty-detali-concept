...
const questions = [
  { question: "Где находится Beauty Detali School?", answer: "Школа находится в Санкт-Петербурге, на Владимирском проспекте, 19 — в одной минуте от метро «Владимирская»." },
  ...
  { question: "Кто преподаёт в школе?", answer: "Занятия ведут действующие стилисты-парикмахеры салонов красоты бизнес-класса. Они делятся опытом работы с клиентами и помогают отрабатывать профессиональную технику." },
...
const learning = [
  { title: "Техника и практика", text: "Учитесь у действующих стилистов салонов бизнес-класса. Отрабатываете технику и получаете обратную связь по своим работам. К курсам предусмотрены авторские учебные пособия." },
  { title: "Сервис и доверие клиента", text: "Разбираете профессиональную этику, общение и рекомендации без давления. Учитесь понимать запрос человека и объяснять ценность своей работы." },
  { title: "Ваше имя в профессии", text: "Узнаёте, как развивать личный бренд, работая в салоне, и формировать базу постоянных клиентов." },
];
function Brand() {
...
export default function Home() {
  return <>
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      "@graph": [
        { "@type": "EducationalOrganization", "@id": `${schoolUrl}/#school`, name: "Beauty Detali School", alternateName: "Школа мастеров красивого бизнеса Detali", url: schoolUrl, description: "Школа парикмахеров и бьюти-профессий в Санкт-Петербурге. Обучение профессиональной технике, сервису и общению с клиентами.", telephone: "+7 911 921-30-19", email: "beauty.detali.school@mail.ru", logo: `${schoolUrl}/brand/detali-black.svg`, address: { "@type": "PostalAddress", streetAddress: "Владимирский проспект, 19", addressLocality: "Санкт-Петербург", addressCountry: "RU" }, sameAs: ["https://vk.com/beauty_detali_school"] },
    ...
    <main id="main">
      <section className="hero" id="top" aria-labelledby="hero-title">
        ...
        <div className="hero-location"><span>САНКТ-ПЕТЕРБУРГ</span><span>1 минута от метро Владимирская</span></div>
        <div className="hero-copy">
          ...
          <p className="hero-lead">Освойте профессию в индустрии красоты.<br className="desktop-break" /> Учитесь у мастеров, которые работают в салонах бизнес-класса.</p>
        ...
        <p className="hero-caption">BEAUTY DETALI<span>Школа и сеть студий красоты</span></p>
      </section>
      ...
      <section className="method-section content-grid wrap section" id="method" aria-labelledby="method-title">
        ...
        <div className="method-copy"><p className="eyebrow">ПРОФЕССИЯ ИЗНУТРИ</p><h2 id="method-title">Рядом с теми,<br />кто умеет.</h2><p className="section-lead">Действующие стилисты помогают освоить технику и почувствовать, как устроена работа с клиентом.</p>
      ...
      <section className="brand-section" id="people" aria-labelledby="brand-title"><div className="brand-layout content-grid wrap">
        <div className="brand-story"><p className="eyebrow">ШКОЛА И СТУДИИ DETALI</p><h2 id="brand-title">Один бренд.<br />Общее чувство<br />прекрасного.</h2><p>Beauty Detali объединяет школу мастеров красивого бизнеса и сеть студий красоты бизнес-класса. Наш опыт работы с клиентами становится частью вашего обучения.</p><div className="founder"><h3>Наталья Горохова</h3><p>Руководитель бренда Detali.<br />Действующий стилист-парикмахер,<br />25 лет в профессии.</p></div><a className="text-link" href="https://taplink.cc/beauty_detali" target="_blank" rel="noreferrer">Сеть студий Beauty Detali</a></div>
