...
export const metadata: Metadata = {
  ...
  description: "Курсы парикмахеров и бьюти-профессий в СПб. Группы до 6 человек, практика на моделях. Метро Владимирская и Достоевская. Бесплатное пробное занятие.",
  icons: {
